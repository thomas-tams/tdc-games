...
import GameStatesRow from "./game_states_table";
...
const tablesSchema = __schema({
  game_states: __table({
    ...
    constraints: [
      { name: 'game_states_room_id_key', constraint: 'unique', columns: ['roomId'] },
    ],
  }, GameStatesRow),
  players: __table({
    name: 'players',
    indexes: [
      ...
      { name: 'byRoomId', algorithm: 'btree', columns: [
        'roomId',
      ] },
    ],
    constraints: [
...
const reducersSchema = __reducers(
  ...
  __reducerSchema("update_game_state", UpdateGameStateReducer),
